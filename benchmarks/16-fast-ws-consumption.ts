/**
 * Benchmark: Consumption Methods (with Fast WebStreams)
 *
 * Mirrors 06-consumption.ts but adds Vercel's experimental-fast-webstreams
...
async function runBenchmarks(): Promise<FourWayComparison[]> {
  ...
  console.log('Running: bytes() collection...');
  {
    ...
    comparisons.push(createFourWayComparison('bytes() (16KB x 500)', newStreamResult, fastWebStreamResult, webStreamResult, nodeStreamResult));
  }
  ...
  console.log('Running: text() decode...');
  {
    ...
    comparisons.push(createFourWayComparison('text() (1KB chunks)', newStreamResult, fastWebStreamResult, webStreamResult, nodeStreamResult));
  }
  ...
  console.log('Running: Direct iterator consumption...');
  {
    ...
    comparisons.push(createFourWayComparison('Iterator loop (8KB x 1000)', newStreamResult, fastWebStreamResult, webStreamResult, nodeStreamResult));
  }
...
// Main
console.log('Benchmark: Consumption Methods (with Fast WebStreams)');
